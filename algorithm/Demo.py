...
class Demo:
    ...
    def k_fold_test(self):
        ...
        for train_index, test_index in kf.split(self.train_data):
            ...
            norkel_ann = NORkEL(temp_train_data, temp_train_target,
            ...
            # predict
            norkel_ann.predict()
            # norkel_ann.ensemble_test()

            peak_f1 = norkel_ann.compute_peak_f1()
            ndcg = norkel_ann.compute_ndcg()
            auc = norkel_ann.compute_auc()
            macro, micro = norkel_ann.compute_macro_micro_f1()
...
if __name__ == '__main__':
    ...
    for file_name in lists:
        ...
        norkel = Demo(file_path, output_file_path + file_name,
